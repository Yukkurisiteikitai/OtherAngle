...
def hihluhnoi():
    ...
    # Make a request to the FastAPI server's streaming endpoint
    with requests.get('http://127.0.0.1:8030/generate/%E3%81%93%E3%81%93%E3%82%8D%E3%81%82%E3%82%93%E3%81%93', stream=True) as r:
        def generate():
            for line in r.iter_lines():
                if line:
                    yield f"Received: {line.decode('utf-8')}\n"
